...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-10-2018 a las 21:22:26
...
--
CREATE DATABASE IF NOT EXISTS `u466347497_psico` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish2_ci;
USE `u466347497_psico`;
...
--
ALTER TABLE `roles`
  MODIFY `id_rol` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Número identificador del rol del usuario.', AUTO_INCREMENT=21;
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Número identificador unico del usuario y clave primaria.', AUTO_INCREMENT=2;
